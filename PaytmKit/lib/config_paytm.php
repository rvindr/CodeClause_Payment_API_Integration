...
// define('PAYTM_MERCHANT_KEY','ZypPTQzexMHmcVEb' ); //Change this constant's value with Merchant key received from Paytm.
// define('PAYTM_MERCHANT_MID', 'DDhyof27077863800613'); //Change this constant's value with MID (Merchant ID) received from Paytm.
...
if (PAYTM_ENVIRONMENT == 'PROD') {
	...
	//Change this constant's value with Merchant key received from Paytm.
	$PAYTM_MERCHANT_MID 		= "Enter_merchant_id_here";
	$PAYTM_MERCHANT_KEY 		= "Enter_merchant_key_here";
